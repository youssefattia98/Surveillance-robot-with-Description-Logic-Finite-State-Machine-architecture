#include <ros/ros.h>
#include <surveillance_fsm_robot/RoomConnection.h>
#include <surveillance_fsm_robot/RoomInformation.h>

bool markerCallback(surveillance_fsm_robot::RoomInformation::Request &req, surveillance_fsm_robot::RoomInformation::Response &res){
	surveillance_fsm_robot::RoomConnection conn;
	switch (req.id){
	case 11:
		res.room = "E";
		res.x = 1.5;
...
{
	ros::init(argc, argv, "surveillance_fsm_robot");
	ros::NodeHandle nh;
